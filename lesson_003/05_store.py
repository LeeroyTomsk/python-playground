...
for item_name, item_code in goods.items():
    item_list = store[item_code]
    count_in_stores = 0
    total_price_of_items = 0
    for item in item_list:
        count_in_stores += item['quantity']
        total_price_of_items += item['quantity']*item['price']
    print(item_name, '-', count_in_stores, ' шт, стоимость ', total_price_of_items, ' руб')
